...
IDVoo varchar(50) foreign key references Voo(ID) not null,
DataUltimaOperação varchar(50) not null,
...
create table Venda (
ID varchar(50) not null primary key,
Cpf varchar(50) foreign key references Passageiro(Cpf) not null,
...
ID varchar(50) not null primary key,
IDVenda varchar(50) foreign key references Venda(ID) not null,
IDPassagem varchar(50) foreign key references PassagemVoo(ID) not null,
